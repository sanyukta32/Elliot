...
import com.ell.qa.util.TestUtil;
...
public class TestBase {
	...
	public TestBase(){
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\Users\\Saura\\eclipse-workspace\\FreeEllTest\\src\\main\\java\\com\\ell\\"
